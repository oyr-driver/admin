...
app.use(bodyParser.json({limit : "50mb"})); //limit를 50mb로 늘림 
app.use(bodyParser.urlencoded({limit:"50mb",extended: true})); //req.body.user, req.body.pw 사용하기 위함 (body-parser)
